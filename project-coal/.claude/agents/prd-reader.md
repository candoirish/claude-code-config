...
- `[Adatomy Clinic][Fix] Fix dispatch timeout on large batches`
- `[Ads Analysis][Feature] Add brand-filtered report export`

**The agent does not have permission to create Atoll issues.** For each spec, present the issue details for the user to create manually:
...
After the user creates the issues and provides the IDs, proceed to Step 7.
